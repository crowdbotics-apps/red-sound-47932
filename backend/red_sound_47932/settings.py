"""
Django settings for red_sound_47932 project.
...
ROOT_URLCONF = 'red_sound_47932.urls'
...
WSGI_APPLICATION = 'red_sound_47932.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_sound_47932 API",
    "DESCRIPTION": "API documentation for red_sound_47932 App",
    "VERSION": "v1",
}
